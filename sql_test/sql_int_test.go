...
func TestSql_DataTypeInt(t *testing.T) {
	...
	colTypesMap := map[promsql.DbFlavor][]string{
		...
		promsql.FlavorPgSql: {"VARCHAR(8)",
			"INT", "INTEGER", "INT", "INTEGER", "INT",
			"INT", "SMALLINT", "INTEGER", "BIGINT",
			"INT", "INT2", "INT4", "INT8"},
		promsql.FlavorSqlite: {"NVARCHAR(8)",
